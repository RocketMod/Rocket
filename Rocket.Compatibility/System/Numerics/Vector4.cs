...
{
    /// <summary>
    /// A structure encapsulating four single precision Singleing point values and provides hardware accelerated methods.
    /// </summary>
    public partial struct Vector4 : IEquatable<Vector4>, IFormattable
    {
        ...
        public Single Length()
        {
            ...
            {
                Single ls = Vector4.Dot(this, this);
        ...
        public static Vector4 Normalize(Vector4 vector)
        {
            ...
            else
            {
                ...
                Single invNorm = 1.0f / (Single)Math.Sqrt((double)ls);
