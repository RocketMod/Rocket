...
namespace System.Numerics
{
    ...
    internal static class BigNumber
    {
        ...
        internal static bool TryValidateParseStyleInteger(NumberStyles style, out ArgumentException e)
        {
            ...
            {
                e = new ArgumentException(nameof(style));
                return false;
            }
        ...
        internal unsafe static Boolean TryParseBigInteger(String value, NumberStyles style, NumberFormatInfo info, out BigInteger result)
        {
            ...
            bignumber.precision = (int) typeof(Number).GetField("precision", BindingFlags.Instance | BindingFlags.NonPublic).GetValue(number);
            bignumber.scale = (int)typeof(Number).GetField("scale", BindingFlags.Instance | BindingFlags.NonPublic).GetValue(number);
            bignumber.sign = (bool)typeof(Number).GetField("sign", BindingFlags.Instance | BindingFlags.NonPublic).GetValue(number);
        ...
        */
                        ...
                        static String FormatBigInteger(BigInteger value, String format, NumberFormatInfo info)
        {
            ...
            catch (OverflowException e) { throw new FormatException(null, e); }
