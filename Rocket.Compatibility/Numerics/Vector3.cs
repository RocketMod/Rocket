...
{
    /// <summary>
    /// A structure encapsulating three single precision Singleing point values and provides hardware accelerated methods.
    /// </summary>
    public partial struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        public Single Length()
        {
            if (Vector.IsHardwareAccelerated)
            {
                ...
                return (Single)System.Math.Sqrt(ls);
            }
            else
            {
        ...
        public static Single Distance(Vector3 value1, Vector3 value2)
        {
            ...
            else
            {
                ...
                return (Single)System.Math.Sqrt((double)ls);
            }
        }
        ...
        public static Vector3 Normalize(Vector3 value)
        {
            ...
            else
            {
                ...
                Single length = (Single)System.Math.Sqrt(ls);
