...
namespace Rocket.API.Providers
    ...
    public static class IRocketPermissionsProviderExtensions
    {
        ...
        public static bool HasPermission(this IRocketPermissionsProvider rocketPermissionProvider, IRocketPlayer player,List<string> requestedPermissions)
        {
        ...
        public static bool AddPlayerToGroup(this IRocketPermissionsProvider rocketPermissionProvider, string group, IRocketPlayer player)
        {
        ...
        public static bool RemovePlayerFromGroup(this IRocketPermissionsProvider rocketPermissionProvider, string group, IRocketPlayer player)
        {
            RocketPermissionsGroup g = rocketPermissionProvider.GetGroup(group);
            if (g != null)
            {
