...
namespace Rocket.API.Commands
{
    ...
    public interface ICommandParameters: IEnumerable<string>
    {
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException">when <i>index</i> is equal or greater than <see cref="Length">length</see> or negative.</exception>
        ...
        /// </summary>
        /// <exception cref="ArgumentOutOfRangeException"><inheritdoc cref="Get{T}(int)"/></exception>
        /// <param name="index"><inheritdoc cref="Get{T}(int)"/></param>
        /// <param name="type">The type to parse the parameter as.</param>
        /// <returns><inheritdoc cref="Get{T}(int)"/></returns>
        object Get(int index, Type type);

        /// <summary>
        /// <inheritdoc cref="Get{T}(int)"/>
        /// </summary>
        /// <typeparam name="T"><inheritdoc cref="Get{T}(int)"/></typeparam>
        /// <param name="index"><inheritdoc cref="Get{T}(int)"/></param>
        /// <param name="defaultValue">The default return value.</param>
        /// <returns>the parsed parameter value if the given index was valid and the parameter could be parsed to the given type; otherwise <i>defaultValue</i>.</returns>
        T Get<T>(int index, T defaultValue);

        /// <summary>
        /// <inheritdoc cref="Get{T}(int, T)"/>
        /// </summary>
        /// <param name="index"><inheritdoc cref="Get{T}(int, T)"/></param>
        /// <param name="type">The type to parse the parameters as.</param>
        /// <param name="defaultValue">The default return value.</param>
        /// <returns><inheritdoc cref="Get{T}(int, T)"/></returns>
        ...
        /// <returns>
        /// <b>true</b> if the given index was valid and the parameter could be parsed to the given type; otherwise <b>false</b>.
        /// </returns>
        ...
        /// </summary>
        /// <param name="index"><inheritdoc cref="TryGet{T}"/></param>
        /// <param name="type">The type to parse the parameters as.</param>
        /// <param name="value">The parsed parameter value.</param>
        /// <returns><inheritdoc cref="TryGet{T}"/></returns>
