...
namespace Rocket.API.Logging
{
    ...
    public interface ILogger : IProxyableService
    {
        ...
        /// <param name="bindings">The message bindings. See <see cref="string.Format(string, object[])"/></param>
        void Log(string message, LogLevel level = LogLevel.Information, Exception exception = null, ConsoleColor? color = null,
