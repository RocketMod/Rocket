...
namespace Rocket.Core.Commands
{
    public class RocketCommandManager : MonoBehaviour
    {
        ...
        public void Add(IRocketCommand command, string alias = null, CommandPriority priority = CommandPriority.Normal)
        {
        ...
        internal void RemoveRange(IRocketCommand p)
        {
            commands.RemoveAll(rc => rc.Command == p);
        }
