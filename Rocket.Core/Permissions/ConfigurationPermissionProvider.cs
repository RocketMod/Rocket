...
namespace Rocket.Core.Permissions
{
    ...
    public class ConfigurationPermissionProvider : IPermissionProvider
    {
        ...
        {
            ConfigurationContext groupsContext = new ConfigurationContext(context, "Groups");
            ...
            ConfigurationContext playersContext = new ConfigurationContext(context, "Players");
        ...
        private bool DeleteConfigSection(IIdentifiable target)
        {
            IConfigurationElement config = target is IPermissionGroup
                ? GroupsConfig["Groups"]
                : PlayersConfig[((ICommandCaller)target).CallerType.Name];
